...
function SampleNextArrow(props: HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <Image alt="left arrow" src="/images/rewards/raffles/global-explorer/arrow-right.svg" height={18} width={18} />
    </div>
  );
}
...
function SamplePrevArrow(props: HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <Image alt="left arrow" src="/images/rewards/raffles/global-explorer/arrow-left.svg" height={18} width={18} />
    </div>
  );
}
