...
import PurchaseModal from "@/components/content/rewards/raffles/global-explorer/purchase-modal";
import ImagesSlider from "@/components/content/rewards/raffles/global-explorer/image-slider";
import ProgressBar from "@/components/content/rewards/raffles/global-explorer/progress-bar";
import CountDown from "@/components/content/rewards/raffles/global-explorer/count-down";
...
const GlobalExplorer = () => {
  const [ticketDetails] = useState<TicketDetails>({
    imgUrls: [
      "/images/rewards/raffles/global-explorer/hero-thumbnail.svg",
  ...
  return (
    <React.Fragment>
      <div className="flex flex-col gap-14 bg-reward-bg items-center">
            ...
            <div className="h-fit p-5 border border-[#CCCBCB] bg-[#FAFAFA] rounded-lg relative max-md:mt-10">
              ...
              <div className="flex flex-col gap-3.5 py-3.5">
                <div className="flex items-center gap-1">
                  <Image
                    src="/images/rewards/raffles/global-explorer/baseline-person.svg"
                    alt="person icon"
                    width={24}
                    height={24}
                    className="h-6 w-6"
                ...
                <div className="flex items-center gap-1">
                  <Image
                    src="/images/rewards/raffles/global-explorer/ticket-fill.svg"
                    alt="ticket icon"
                    width={24}
                    height={24}
                    className="h-6 w-6"
