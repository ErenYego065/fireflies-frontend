  ...
  return (
    <div className="bg-streak-bg pt-[42px] 2xl:pt-[77px]">
      ...
      <div className="mx-[42px] flex flex-col gap-[14px] md:flex-row md:mx-10 2xl:mx-[135px]">
        <Image
          src="/images/rewards/streak/card1.svg"
          alt="card1"
          width={100}
          height={0}
        ...
        />
        <Image
          src="/images/rewards/streak/card2.svg"
          alt="card2"
          width={100}
          height={0}
          className="w-full md:hidden"
        />
        <Image
          src="/images/rewards/streak/card3.svg"
          alt="card3"
          width={100}
          height={0}
          className="w-full md:hidden"
        />
        <Image
          src="/images/rewards/streak/card-desktop1.svg"
          alt="card3"
          width={100}
          height={0}
        ...
        />
        <Image
          src="/images/rewards/streak/card-desktop2.svg"
          alt="card3"
          width={100}
          height={0}
          className="hidden md:block grow"
        />
        <Image
          src="/images/rewards/streak/card-desktop3.svg"
          alt="card3"
          width={100}
          height={0}
          className="hidden md:block grow"
      ...
      {session && <div className="mt-[22px] px-[135px] font-[family-name:var(--font-nunito)] bg-streak-dashboard">
        <h2 className="my-6 font-bold text-[40px] leading-[55px] text-[#6A727F]">
          Dashboard
        </h2>
